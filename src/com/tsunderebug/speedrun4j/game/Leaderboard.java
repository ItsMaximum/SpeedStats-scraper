...
public class Leaderboard {
	...
	public static Leaderboard forCatAndSubCat(Game game, Category cat, LinkedHashMap<String,String> subcats) throws IOException {
		...
		URL u = new URL(Speedrun4J.getAPI_ROOT() + "leaderboards/" + game.getId() + "/category/" + cat.getId() + "?_bulk=yes&max=5000" + sc);
	...
	public static Leaderboard forCatAndSubCatAndLevel(Game game, Category cat, LinkedHashMap<String,String> subcats, Level lev) throws IOException {
		Gson g = new Gson();
		String sc = "";
		if(subcats.keySet().size() > 0) {
			sc = "&var-" + subcats.toString();
		...
		URL u = new URL(Speedrun4J.getAPI_ROOT() + "leaderboards/" + game.getId() + "/level/" + lev.getId() + "/" + cat.getId() + "?_bulk=yes&max=5000" + sc);
		HttpURLConnection conn = (HttpURLConnection) u.openConnection();
		conn.setRequestProperty("User-Agent", Speedrun4J.USER_AGENT);
		InputStreamReader r = new InputStreamReader(conn.getInputStream());
		LeaderboardData l = g.fromJson(r, LeaderboardData.class);
	...
	public static Leaderboard forCategory(Game game, Category c) throws IOException {
		Gson g = new Gson();
		URL u = new URL(Speedrun4J.getAPI_ROOT() + "leaderboards/" + game.getId() + "/category/" + c.getId() + "?_bulk=yes&max=5000");
		HttpURLConnection conn = (HttpURLConnection) u.openConnection();
		conn.setRequestProperty("User-Agent", Speedrun4J.USER_AGENT);
		InputStreamReader r = new InputStreamReader(conn.getInputStream());
		LeaderboardData l = g.fromJson(r, LeaderboardData.class);
	...
	public static Leaderboard forCategoryAndLevel(Game game, Category c, Level lev) throws IOException {
		Gson g = new Gson();
		URL u = new URL(Speedrun4J.getAPI_ROOT() + "leaderboards/" + game.getId() + "/level/" + lev.getId() + "/" + c.getId() + "?_bulk=yes&max=5000");
		HttpURLConnection conn = (HttpURLConnection) u.openConnection();
		conn.setRequestProperty("User-Agent", Speedrun4J.USER_AGENT);
		InputStreamReader r = new InputStreamReader(conn.getInputStream());
		LeaderboardData l = g.fromJson(r, LeaderboardData.class);
	...
	public static Leaderboard forCategoryTopTenOnDate(Game game, Category c, String date) throws IOException {
		Gson g = new Gson();
		URL u = new URL(Speedrun4J.getAPI_ROOT() + "leaderboards/" + game.getId() + "/category/" + c.getId() + "?top=10" + "&date=" + date);
		HttpURLConnection conn = (HttpURLConnection) u.openConnection();
		conn.setRequestProperty("User-Agent", Speedrun4J.USER_AGENT);
		InputStreamReader r = new InputStreamReader(conn.getInputStream());
		LeaderboardData l = g.fromJson(r, LeaderboardData.class);
	...
	public static Leaderboard forCategoryOnDate(Game game, Category c, String date) throws IOException {
		Gson g = new Gson();
		URL u = new URL(Speedrun4J.getAPI_ROOT() + "leaderboards/" + game.getId() + "/category/" + c.getId() + "?date=" + date);
		HttpURLConnection conn = (HttpURLConnection) u.openConnection();
		conn.setRequestProperty("User-Agent", Speedrun4J.USER_AGENT);
		InputStreamReader r = new InputStreamReader(conn.getInputStream());
		LeaderboardData l = g.fromJson(r, LeaderboardData.class);
	...
	public static Leaderboard forCategoryTopXOnDate(Game game, Category c, String date, int x) throws IOException {
		Gson g = new Gson();
		URL u = new URL(Speedrun4J.getAPI_ROOT() + "leaderboards/" + game.getId() + "/category/" + c.getId() + "?top=" + x + "&date=" + date);
		HttpURLConnection conn = (HttpURLConnection) u.openConnection();
		conn.setRequestProperty("User-Agent", Speedrun4J.USER_AGENT);
		InputStreamReader r = new InputStreamReader(conn.getInputStream());
		LeaderboardData l = g.fromJson(r, LeaderboardData.class);
	...
	public static Leaderboard forCategoryWROnDate(Game game, Category c, String date) throws IOException {
		Gson g = new Gson();
		URL u = new URL(Speedrun4J.getAPI_ROOT() + "leaderboards/" + game.getId() + "/category/" + c.getId() + "?top=1" + "&date=" + date);
		HttpURLConnection conn = (HttpURLConnection) u.openConnection();
		conn.setRequestProperty("User-Agent", Speedrun4J.USER_AGENT);
		InputStreamReader r = new InputStreamReader(conn.getInputStream());
		LeaderboardData l = g.fromJson(r, LeaderboardData.class);
	...
	public void setRuns(PlacedRun[] runs) {
		this.runs = runs;
	}
