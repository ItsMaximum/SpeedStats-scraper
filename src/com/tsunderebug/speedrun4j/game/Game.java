...
public class Game {
	...
	private Link[] links;
	private ArrayList<categoryRunList> categoryRunLists;


	public ArrayList<categoryRunList> getCategoryRunLists() {
		return categoryRunLists;
	}

	public void setCategoryRunLists(ArrayList<categoryRunList> categoryRunLists) {
		this.categoryRunLists = categoryRunLists;
	}

	public static Game fromID(String id) throws IOException {
		Gson g = new Gson();
		URL u = new URL(Speedrun4J.getAPI_ROOT() + "games/" + id);
